...
- 細々した機能
    - [x] 画面のデザインを考える
    - [x] 画面遷移の図を作る
    - [ ] クレジット一覧の生成ができなくなってしまったので修正
        - docs/credits/README.md の方法でクレジット一覧が生成できなくなってしまったので直す
    - [ ] Win/Mac でバイナリ配布する (ウィルス誤検知対策等もちゃんとやる)
    - [ ] UI にこだわる
    ...
    - [ ] js で UI を構築できるようにする
        ...
        - [x] テキストを描画できる
            ...
            - 代わりに Apache-2.0 ライセンスの [Roboto](https://github.com/googlefonts/RobotoMono) が良さそうに思う
        ...
        - [x] マウスイベントを受け取ることができる
        - [ ] ボタンやつまみ、グラフ表示などの標準ライブラリを用意する
    - [x] console.log が画面に出るようにする
